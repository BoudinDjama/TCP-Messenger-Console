...
Basic socket-based message handling.  


**Setup**  
Run one instance of the application as the server.  
Run at least two other instances (on the same or different LAN-connected computers) as clients.  
